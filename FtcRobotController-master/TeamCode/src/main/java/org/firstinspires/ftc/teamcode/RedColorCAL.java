...
public class RedColorCAL extends LinearOpMode {
...
//        sensorColor = hardwareMap.get(ColorSensor.class, "sensor_color_distance");
        sensorColorleft = hardwareMap.get(ColorSensor.class, "sensor_color_left");
...
//
        ...
        while (opModeIsActive()) {
            ...
            telemetry.addData("Alpha", sensorColorleft.alpha());
