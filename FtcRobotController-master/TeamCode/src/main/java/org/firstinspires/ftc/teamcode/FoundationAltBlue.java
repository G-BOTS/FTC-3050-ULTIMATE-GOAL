...
public class FoundationAltBlue extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        encoderDrive(DRIVE_SPEED,   6, 6, 5.0);  // S1:  24 Drive forward 4 Sec timeout
        rotate(-28, TURN_SPEED);
        encoderDrive(DRIVE_SPEED,   16, 16, 5.0);  // S1:  24 Drive forward 4 Sec timeout
        encoderDrive(0.2,   3, 3,4.0);
